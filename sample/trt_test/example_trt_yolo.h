...
int test_yolo()
{
    std::string testDir   = R"(E:\demo\rep\AIFramework\models\)";
    std::string modelPath = testDir + "yolov5s.trt.enginene";
    float       nms_thr   = 0.25f;
    ...
    std::string             img_dir = R"(E:\demo\rep\AIFramework\data\test_img\coco128\train2017\*.jpg)";
